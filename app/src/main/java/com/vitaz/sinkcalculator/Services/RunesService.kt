...
object RunesService {
    ...
    val runes = listOf<Rune>(
        Rune("Initiative", "Ini", 10, 0.1, 0.05,  1010),
        Rune("Initiative", "Pa Ini", 30, 0.1, 0.05,  1010),
        Rune("Initiative", "Ra Ini", 100, 0.1, 0.05,  1010),
        Rune("Vitality", "Vit", 5, 0.2, 0.1, 505),
        Rune("Vitality", "Pa Vit", 15, 0.2, 0.1,  505),
        Rune("Vitality", "Ra Vit", 50, 0.2, 0.1, 505),
        Rune("Pods", "Pod", 10, 0.25, 0.125, 404),
        Rune("Pods", "Pa Pod", 30, 0.25, 0.125,  404),
        Rune("Pods", "Ra Pod", 100, 0.25, 0.125, 404)
